...
class ComputeManager(manager.Manager):
    ...
    def _shutdown_instance(self, context, instance,
        ...
        for bdm in vol_bdms:
            try:
                ...
                self.volume_api.check_and_terminate_connection(
                    context, bdm.volume_id, connector, self.host)
    ...
    def _detach_volume(self, context, volume_id, instance, destroy_bdm=True):
        ...
        self.volume_api.check_and_terminate_connection(context, volume_id,
                                                       connector, self.host)
    ...
    def remove_volume_connection(self, context, volume_id, instance):
        ...
        try:
            ...
            connector = self.driver.get_volume_connector(instance)
            self.volume_api.check_and_terminate_connection(
                context, volume_id, connector, self.host)
    ...
    def _post_live_migration(self, ctxt, instance,
        ...
        for bdm in bdms:
            ...
            if bdm.is_volume:
                self.volume_api.check_and_terminate_connection(
                    ctxt, bdm.volume_id, connector, self.host)
