...
CONF.import_opt('baremetal_scheduler_default_filters',
...
class FilterScheduler(driver.Scheduler):
    ...
    def _schedule(self, context, request_spec, filter_properties):
        ...
        try:
            inst_hyper_type = request_spec['image']['properties'].get(
        ...
        for num in range(num_instances):
            ...
            hosts = self.host_manager.get_filtered_hosts(hosts,
                    filter_properties, filter_class_names=filter_class_names,
                    index=num)
            if not hosts:
